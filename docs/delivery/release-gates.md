...
| G7 Operations             | backup/restore, restart recovery, disk limits, TLS/WOPI proof, vulnerability scan    | Consistent backup/isolated restore and forced document-worker recovery passed; signed Collabora WOPI edit/save passed locally and forged/stale requests failed closed; all four public runtime images passed fixable High/Critical scanning in GitHub run `34796064411`; interrupted AI/native recovery, disk limits and deployed TLS proof remain |
