...
| G8 Publication            | public repository, clean clone CI, tagged source release and SBOM                    | Public prerelease source exists at `replex-me/spellbook`; local clean clone and public GitHub CI passed; tagged release and SBOM remain                       |
