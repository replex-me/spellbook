...
p = ET.parse('services/document-worker/fonts/spellbook-korean-fallback.conf').getroot()
m = p.findall('match')
...
`,
  ...
  assert.match(
    readFileSync("services/document-worker/Dockerfile", "utf8"),
